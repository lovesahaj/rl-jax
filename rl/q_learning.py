...
def benchmark(trained_env, train_rewards=None, num_episodes=100, max_steps=500):
    """Evaluate the greedy policy of a trained Q-learning agent."""
    ...
    save_results(os.path.join(OUTPUT_DIR, "q_learning_metrics.npz"), [summary])
    print(f"Q-learning benchmark saved to {OUTPUT_DIR}/q_learning_metrics.npz")
